 ...
 * 二分搜索：查找第一个等于目标值的元素
 *
 * 这个版本的二分搜索用于在有序数组中查找第一个等于目标值的元素。
 * 当找到一个等于目标值的元素时，我们不会立即返回，而是继续在左侧的元素中查找，直到找到第一个等于目标值的元素。
 */
public class Code_02_findFirstIdx {
    /**
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            // 使用二分搜索查找目标值
            int index = findFirstIndex(array, target);
